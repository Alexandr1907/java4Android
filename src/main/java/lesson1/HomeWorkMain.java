...
//10<=int1+int2<=20
    //task 4
    public static boolean tenToTwenty(int int1, int int2) {
        return int1 + int2 >= 10 && int1 + int2 <= 20;
    }

    // task 5
    public static String posNeg(int int1) {
        if (int1 >=0) {
            return "positive";
        } else {
            return "negative";
    ...
    //task 6
    public static boolean isNeg(int int4) {
        return int4 < 0;
    }
